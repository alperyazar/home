...
![Aldığım Sertifika](/assets/img/23/15-necati-sertifika.jpg){:.centered .lazyload}
...
Aslında Kaan Hoca'dan bu kurs öncesinde 120 saatlik bir C kursu da almıştım,
...
![Aldığım Sertifika](/assets/img/23/15-necati-akis.png){:.centered .lazyload}

{:.text-align-center}
Not alma akışım

![markdown çevirim](/assets/img/23/15-necati-md-cevrim.png){:.centered .lazyload}
...
![struct istatistik](/assets/img/23/15-necati-struct.png){:.centered .lazyload}
...
![CSD Duyuru](/assets/img/23/15-necati-csd-duyuru.png){:.centered .lazyload}
...
![Doulos](/assets/img/23/15-necati-doulos.png){:.centered .lazyload}
...
**Necati ve Kaan Bey kadar dile bu kadar hakim birilerine denk gelmeniz de pek
...
"Eğitim Talep Formu"nu hemen yere bırakın ve alabiliyorsanız genele açılan
...
- Genel kursların saatleri mesai saatleri dışında olacak şekilde ayarlanıyor. Bu
...
![Embedded C](/assets/img/23/15-necati-embedded-c.png){:.centered .lazyload}
...
Hoca ve ders karşılaştırması yapmak gerçekten çok öznel bir şey. Hiç
...
Necati Ergin: [GitHub](https://github.com/necatiergin/),
...
> ile limitleyince Markdown formatında 820 satır tutuyor. 60 derste tuttuğum
