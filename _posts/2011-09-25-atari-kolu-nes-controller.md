...
![Tank oyununda babam ile yaptığımız rekor.](/assets/img/11/5-a.jpg){:.centered}
...
![Emektar Atarim](/assets/img/11/5-b.jpg){:.centered}
...
Karşılaştığım diğer bir zorluk da hangi kablonun ne işe yaradığını bulmak oldu.
...
![Bendeki Atari Kolunun Soketi](/assets/img/11/5-c.jpg){:.centered}
...
![Atari Kolunun Pin Bağlantıları](/assets/img/11/5-d.jpg){:.centered}
...
![Atari kolunu takabileceğiniz erkek seri port soketi](/assets/img/11/5-e.jpg){:.centered}
...
![Atari kolunu kullanmak için örnek bir sinyalizasyon](/assets/img/11/5-f.jpg){:.centered}
...
{% include youtubePlayer.html id="JlvE-LjGIOQ" %}
